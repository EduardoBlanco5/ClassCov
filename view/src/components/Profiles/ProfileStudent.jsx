...
function ProfileStudent() {
  ...
  return (
    <div className='flex justify-center'>
        <div className='bg-zinc-800/70 max-w-md w-full p-10 rounded-md text-white mt-8'>
        ...
        {roleA === 'admin' && (
          ...
          <Card className=' w-md p-5 bg-slate-800'>
            ...
            <CardBody className="px-3 py-0 text-small text-default-400">
              <p className='text-primary-500'>Telefono:<span className='text-default-500 ml-5'>{phone}</span> </p>
              <p className='pt-2'>Fecha de nacimiento: <span className='ml-5'>{date_of_birth}</span> </p>
              <p className='pt-2'>Fecha de Admisión: <span className=' ml-5'>{admission}</span></p>
              
            </CardBody>
            <CardFooter className="gap-3">
              <div className="flex gap-1">
                
                <p className="font-semibold text-primary-400 text-small ">Status: </p>
                <p className=" text-default-400 text-small ml-1">{status}</p>
              </div>
              <div className="flex gap-1">
                <p className="font-semibold text-primary-400 text-small">Tutor: </p>
                <p className="text-default-400 text-small ml-1">{nameG}</p>
              </div>
            </CardFooter>
