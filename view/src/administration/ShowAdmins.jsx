                            ...
                            <Card className='w-md p-5 bg-primary-300 shadow-none'>
                                ...
                                <CardHeader className='flex gap-5'>
                                    <div className=' flex gap-5'>
                                        {admin.file && (
                                            ...
                                            <h4 className="text-small font-semibold leading-none text-primary-900">{admin.name}</h4>
                                            <h5 className="text-small tracking-tight text-default-400 hover:text-red-500 hover:duration-700">{admin.email}</h5>
                                        </div>

                                    </div>
                                </CardHeader>
                                <CardBody className="px-3 py-0 text-small text-default-400">
                                <p className='text-primary-900'>Telefono:<span className='text-default-900 ml-5'>{admin.phone}</span> </p>
                                        <p className='pt-2'>Fecha de nacimiento: <span className='ml-5 text-default-900'>{admin.date_of_birth}</span> </p>
                                        <p className='pt-2'>Rol: <span className=' ml-5 text-default-900'>{admin.role}</span></p>
                                </CardBody>
                                ...
                                <div className='flex justify-between w-full'>
                                    ...
                                    <div className="flex gap-1 ">
                                        ...
                                        <p className=" text-default-900 text-small ml-1">{admin.status}</p>
                                    </div>
                                    <div className="flex gap-1 ">
